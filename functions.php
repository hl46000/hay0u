...
include_once('post-type-h0u.php');
...
array(
    ...
    "appimg" => array(
    	"name" => "appimg",
    	"std" => "English multiple images separated by commas",
    	"title" => "Cover Image Address:"),
);
...
function create_meta_box() {
    ...
    if ( function_exists('add_meta_box') ) {
        add_meta_box( 'new-meta-boxes', 'Above_all_690', 'new_meta_boxes', 'post', 'normal', 'high' );
    }
}
...
function par_pagenavi($range = 9){
  ...
  echo "<li><a href='" . get_pagenum_link(1) . "' class='extend' title='Oldest'>&laquo;</a></li>";
  ...
  echo "<li><a href='" . get_pagenum_link($max_page) . "' class='extend' title='Last page'>&raquo;</a></li>";
  }
  }

register_nav_menus(
array(
'nav-menu' => __( 'Primary Navigation' )
)
);
...
$popimg=get_option( 'hay0u_popimg');
$first_img = "$popimg";
}
return $first_img;
}
